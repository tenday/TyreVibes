...
*   **Integrated Voice Commands:** System voice controls can make interaction natural and non-intrusive during physical work on the vehicle.

## 4. Spatial Vehicle Guidance (Contextual Help)
*   **AR Manuals:** Floating information panels or holograms can appear directly beside the vehicle. For example, tire pressure data can be projected near the relevant wheel.
*   **Local Vision Processing:** Utilizing the M2 and R1 chips, CoreML models for visual recognition (license plate reading, tire DOT code extraction, brand recognition) can run locally with minimal latency, strictly adhering to the app's *Privacy-first* philosophy.
...
*   **ML Libraries:** CoreML models can be optimized for visionOS, taking advantage of Metal acceleration.
